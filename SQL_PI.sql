...
INSERT INTO Noticias (titulo, subtitulo, corpo)
...
VALUES ('Equipe nacional conquista ouro inédito em campeonato mundial de esportes aquáticos',
        ...
        'A delegação brasileira fez história no campeonato mundial de esportes aquáticos, ao conquistar a medalha de ouro pela primeira vez na história do país. Os atletas demonstraram talento e determinação, superando desafios e competindo em alto nível. A vitória não apenas enche de orgulho a nação, mas também destaca a qualidade do esporte brasileiro em âmbito global.');
...
VALUES ('Nova produção cinematográfica nacional conquista prêmio internacional',
        ...
        'Uma produção cinematográfica nacional acaba de conquistar um prestigioso prêmio internacional em um renomado festival de cinema. O filme, que conta uma história envolvente e inovadora, recebeu elogios da crítica e do público. A conquista destaca o talento dos profissionais envolvidos na produção audiovisual brasileira, reafirmando a posição do país no cenário mundial do entretenimento.');
...
VALUES ('Congresso Nacional aprova reforma previdenciária para equilibrar as contas públicas',
        ...
        'O Congresso Nacional aprovou, por ampla maioria, uma abrangente reforma previdenciária com o objetivo de equilibrar as contas públicas. As medidas buscam garantir a sustentabilidade do sistema previdenciário a longo prazo, enfrentando os desafios demográficos e econômicos que o país enfrenta.');
...
VALUES ('Time de futebol brasileiro conquista título inédito na Liga dos Campeões',
        ...
        'O time brasileiro de futebol fez história ao conquistar o título inédito na Liga dos Campeões. Em uma final emocionante, a equipe demonstrou habilidade e determinação, vencendo o jogo por uma margem estreita. A conquista representa um marco para o esporte brasileiro e enche de orgulho os fãs.');
...
VALUES ('Artista brasileiro recebe prêmio internacional de melhor atuação em filme dramático',
        ...
        'Um renomado artista brasileiro foi premiado internacionalmente como o melhor em sua atuação em um filme dramático. O reconhecimento destaca o talento excepcional do artista e coloca o Brasil no cenário global do entretenimento. A premiação foi recebida com entusiasmo pela indústria cinematográfica nacional.');
